...
class gsp_principalesAustro_reportesbitacoraTrama_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraTrama.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',27,['action':("bitacoraTrama"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
...
public static final long LAST_MODIFIED = 1567026043749L
